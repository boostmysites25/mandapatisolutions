      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="wrapper py-16 md:py-24 relative z-10 text-center">
            <h1
              className="text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary mb-4"
              data-aos="fade-up"
            >
              {service.title}
            </h1>
      ...
      <div className="wrapper pb-12 md:pb-20">
        ...
        <section className="mb-16 md:mb-20">
          <div className="flex items-center mb-6 md:mb-8">
            <div
              className="h-0.5 bg-gradient-to-r from-primary to-primary w-12 md:w-16 mr-3 md:mr-4"
              data-aos="fade-right"
            />
            <h2
        ...
        <section className="mb-16 md:mb-20">
          <div className="flex items-center mb-6 md:mb-8">
            <div
              className="h-0.5 bg-gradient-to-r from-primary to-blue-500 w-12 md:w-16 mr-3 md:mr-4"
              data-aos="fade-right"
            />
            <h2
              className="text-xl md:text-2xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500"
              data-aos="fade-left"
            >
              OUR PROCESS
            </h2>
        ...
        >
          ...
          <div className="mt-8 md:mt-12 text-center" data-aos="fade-up">
            ...
            >
              <Link
                to="/contact-us"
                className="px-6 py-3 btn-rounded bg-gradient-to-r from-primary to-primary shadow-lg hover:shadow-xl hover:shadow-primary/20 transition-all duration-300 flex items-center mx-auto"
              >
