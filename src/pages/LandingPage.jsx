        ...
        >
          ...
          <div className="2xl:absolute right-0 top-1/2 2xl:-translate-y-1/2 p-5 2xl:px-10 2xl:w-2/5">
            ...
            >
              ...
              solutions including AI development, mobile applications, web development, 
              digital marketing, and e-commerce platforms to transform your business vision into reality.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-[40%,1fr] gap-7">
          ...
          <div data-aos="fade-up" className="space-y-3">
            ...
            <p className="desc text-white/70">
              ...
              technology solutions that drive business growth and success. Our 
              comprehensive services include AI development, mobile applications, 
              full-stack web development, digital marketing, e-commerce platforms, 
              and software training. We combine technical excellence with strategic 
              thinking to deliver solutions that make a real impact on your business. 
              Whether you need a scalable web platform, a high-performance mobile app, 
              or comprehensive digital services, we have the expertise to bring your 
              vision to life.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <div className="w-4 h-4 min-w-4 bg-secondary rounded-full mt-[.30rem]" />
                <p className="desc">
                  Expert Team Delivering Measurable Business Results
                </p>
              </div>
            </div>
          </div>
